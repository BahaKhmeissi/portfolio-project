...
const Contact = () => {
  ...
  const mobileIcon = darkMode
    ...
    : "hover:scale-125 hover:text-red-600 transition ease-in-ou ";
  const color = darkMode ? "text-gray-300" : "text-[#0a192f]";

  const collaborateBtn = darkMode
    ? " rounded-[10px]  text-white border-2 hover:bg-red-600 hover:border-red-600 px-4 py-3 my-8 mx-auto flex items-center rounded-lg "
    : " rounded-[10px]  text-black border-2 border-black font-bold hover:bg-red-600 hover:border-red-600 px-4 py-3 my-8 mx-auto flex items-center rounded-lg ";
  return (
    <>
      <div
        name="contact"
      ...
      >
        ...
        >
          <div className="pb-8">
            <p
              className={`text-4xl font-bold inline border-b-4 border-red-600 ${
          ...
          <textarea
            ...
            required
          ></textarea>
          <button className={collaborateBtn}>Let's Collaborate</button>
        </form>
      </div>
      <div
