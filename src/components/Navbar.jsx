...
const Navbar = () => {
  ...
  const navLi =
    "hover:scale-125 hover:text-red-600 font-bold transition ease-in-out ";
  const mobileNavLi = "hover:text-red-600 font-bold ";
  const asideIcon =
  ...
  return (
    <div className=" z-50 fixed w-full h-[80px] flex justify-between items-center px-4  bg-[#171717]  text-gray-300 shadow-md ">
      <div>
        <span>
      ...
      <div
        onClick={handleClick}
        className="md:hidden  z-10 cursor-pointer  hover:text-red-600 font-bold"
      >
        {!nav ? <FaBars /> : <FaTimes />}
      </div>
      ...
      <div className="hidden lg:flex fixed  flex-col top-[35%] left-0">
        <ul>
          <li className={`pl-5 font-medium bg-[#1b5589] ${asideIcon}`}>
            <a
              className={iconLink}
          ...
          <li className={` pl-5 font-medium  bg-[#5a085a] ${asideIcon}`}>
            <a
              className={iconLink}
              href="https://www.instagram.com/bahakhmaissi/"
              target="blank"
            >
